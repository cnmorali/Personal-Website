    ...
    <div id='about' className='w-full p-2 flex flex-col items-center'>
      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 p-8'>
        <div className='col-span-2'>
          <p className='py-2 text-stone-600'>I&apos;m seeking a challening engineering position at a global tech company that differentiates itself through innovation, customer delight, and talent development.</p>
